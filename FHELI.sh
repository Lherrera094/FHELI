...
#SBATCH --cpus-per-task=96          			# Use all 96 logical cores (48 cores × 2 threads)
#SBATCH --mem=370000M               			# ~370GB (leave 10GB for system overhead)
...
#SBATCH --partition=cpu  				# Replace with your cluster's partition name
