...
#SBATCH --cpus-per-task=64                              # Max=96 logical cores (48 cores × 2 threads) for CPU
#SBATCH --mem=60000M                                   # ~370GB (leave 10GB for system overhead)
...
#SBATCH --partition=cpu_il                              # bwHPC=cpu_il, cpu, highmem, gpu_h100, gpu_mi300
